...
class CommonModel {
     ...
     */
    static mergeProperties(mergeTo, mergeFrom, originalInput, alreadyIteratedModels = new Map()) {
     ...
     * @param alreadyIteratedModels
     */
    static mergeAdditionalProperties(mergeTo, mergeFrom, originalInput, alreadyIteratedModels = new Map()) {
     ...
     * @param alreadyIteratedModels
     */
    static mergeAdditionalItems(mergeTo, mergeFrom, originalInput, alreadyIteratedModels = new Map()) {
    ...
    static mergeItems(mergeTo, mergeFrom, originalInput, alreadyIteratedModels = new Map()) {
        ...
        if (Array.isArray(mergeFrom.items) && Array.isArray(mergeToItems)) {
            for (const [index, mergeFromTupleModel] of mergeFrom.items.entries()) {
                mergeTo.items[Number(index)] =
                    CommonModel.mergeCommonModels(mergeToItems[Number(index)], mergeFromTupleModel, originalInput, alreadyIteratedModels);
            }
        }
     ...
     * @param alreadyIteratedModels
     */
    static mergePatternProperties(mergeTo, mergeFrom, originalInput, alreadyIteratedModels = new Map()) {
                ...
                for (const [pattern, patternModel] of Object.entries(mergeFromPatternProperties)) {
                    if (mergeToPatternProperties[String(pattern)] !== undefined) {
                        ...
                        mergeToPatternProperties[String(pattern)] =
                            CommonModel.mergeCommonModels(mergeToPatternProperties[String(pattern)], patternModel, originalInput, alreadyIteratedModels);
                    }
                    else {
     ...
     * @param alreadyIteratedModels
     */
    static mergeCommonModels(mergeTo, mergeFrom, originalInput, alreadyIteratedModels = new Map()) {
