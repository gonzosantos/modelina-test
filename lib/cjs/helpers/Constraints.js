...
exports.checkForReservedKeyword = exports.NO_RESERVED_KEYWORDS = exports.NO_EMPTY_VALUE = exports.NO_DUPLICATE_ENUM_KEYS = exports.NO_DUPLICATE_PROPERTIES = exports.NO_NUMBER_START_CHAR = void 0;
function NO_NUMBER_START_CHAR(value) {
...
exports.NO_NUMBER_START_CHAR = NO_NUMBER_START_CHAR;
/**
 ...
 */
function NO_DUPLICATE_PROPERTIES(constrainedObjectModel, objectModel, propertyName, namingFormatter) {
    ...
    const alreadyPartOfConstrainedModel = Object.keys(constrainedObjectModel.properties).includes(formattedPropertyName);
...
exports.NO_DUPLICATE_PROPERTIES = NO_DUPLICATE_PROPERTIES;
/**
 ...
 */
function NO_DUPLICATE_ENUM_KEYS(constrainedEnumModel, enumModel, enumKey, namingFormatter, enumKeyToCheck = enumKey, onNameChange = (currentEnumKey) => {
    return `reserved_${currentEnumKey}`;
}, onNameChangeToCheck = onNameChange) {
...
exports.NO_DUPLICATE_ENUM_KEYS = NO_DUPLICATE_ENUM_KEYS;
function NO_EMPTY_VALUE(value) {
    if (value === '') {
        return 'empty';
    }
    return value;
}
exports.NO_EMPTY_VALUE = NO_EMPTY_VALUE;
function NO_RESERVED_KEYWORDS(propertyName, reservedKeywordCallback) {
    if (reservedKeywordCallback(propertyName)) {
        return `reserved_${propertyName}`;
    }
    return propertyName;
}
exports.NO_RESERVED_KEYWORDS = NO_RESERVED_KEYWORDS;
function checkForReservedKeyword(word, wordList, forceLowerCase = true) {
...
exports.checkForReservedKeyword = checkForReservedKeyword;
