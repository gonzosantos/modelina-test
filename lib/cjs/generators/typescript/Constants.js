 ...
 */
function isReservedTypeScriptKeyword(word, forceLowerCase = true) {
    return ((0, helpers_1.checkForReservedKeyword)(word, exports.RESERVED_TYPESCRIPT_KEYWORDS, forceLowerCase) || (0, Constants_1.isReservedJavaScriptKeyword)(word));
}
