...
exports.DefaultPropertyKeyConstraints = {
    ...
    NO_RESERVED_KEYWORDS: (value) => {
        if ((0, Constants_1.isReservedCplusplusKeyword)(value)) {
            return `_${value}`;
        }
        return value;
    }
...
/**
 * Default constraint logic for Cplusplus, which converts the object property key into something that is compatible with Cplusplus
 */
