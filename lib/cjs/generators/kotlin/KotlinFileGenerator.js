...
class KotlinFileGenerator extends _1.KotlinGenerator {
    /**
    ...
    generateToFiles(input, outputDirectory, options, ensureFilesWritten = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const outputModel of generatedModels) {
                const filePath = path.resolve(outputDirectory, `${outputModel.modelName}.kt`);
...
//# sourceMappingURL=KotlinFileGenerator.js.map